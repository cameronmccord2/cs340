...
public interface IMaritimeTradeOverlay extends IOverlayView {
	 ...
	 * 1. Hides all the "get" resources except the selected one
	 * 2. Displays and disables the selected "get" resource
	 * 3. Displays the "get" undo components using the specified amount
	 * 
	 ...
	 * Specifically, this method does the following:
	 * 1. Hides all the "give" resources except the selected one
	 * 2. Displays and disables the selected "give" resource
	 * 3. Displays the "give" undo components using the specified amount
	 * 
