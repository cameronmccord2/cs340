...
public interface IDomesticTradeController extends IController {
	 ...
	 */
	void decreaseResourceAmount(ResourceType resource);// done
	 ...
	 */
	void increaseResourceAmount(ResourceType resource);// done
	
	/**
	 * Called by the domestic trade overlay when the user clicks the trade button.
	 */
	void sendTradeOffer();// done
	 ...
	 */
	void setResourceToReceive(ResourceType resource);// done
	 ...
	 */
	void setResourceToSend(ResourceType resource);// done
	 ...
	 */
	void unsetResource(ResourceType resource);// done
	
	/**
	 * Called by the domestic trade overlay when the user cancels a trade.
	 */
	void cancelTrade();// done
	 ...
	 */
	void acceptTrade(boolean willAccept);// not me
}
